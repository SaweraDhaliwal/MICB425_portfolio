...
#creating the collector's curve 
#!!!

#diversity estiamtes (alpha diversity)
...
#alpha diversity functions in R (load vegan)
...
##calculate the Simpson Reciprocal Index
diversity(community_data_diversity, index="invsimpson")

##calculate the Chao1 richness estimator
