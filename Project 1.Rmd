...
summary(lm(formula = TaxAbundance ~ TotAbundance, data = mothur_taxon)) # why was this done
summary(lm(formula = TaxAbundance ~ TotAbundance, data = qiime2_taxon)) # why was this done
